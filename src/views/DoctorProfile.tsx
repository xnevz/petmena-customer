...
import { NavigatorRouteTypes } from '../routing/NavigatorRouteTypes';
...
export default function DoctorProfile({ route }: { route: RouteProp<NavigatorRouteTypes, 'doctorDetail'>; }) {
    const doctor_data = route.params.doctor;
            ...
            <View style={styles.details}>
                ...
                <Center style={styles.avatar}>
                    <Avatar
                        bg="gray.500"
                        source={{
                            uri: img_url + doctor_data.profile_image,
                        }}
                        size={180}>
                        PP
                    </Avatar>
                    ...
                    {/* stars */}
                    <FiveStars yellowCount={doctor_data.overall_rating} size={15} />
                </Center>
                ...
                <ScrollView px="10px">
                    ...
                    <Flex direction="row" align="center">
                        ...
                        <Button flex={1} _text={{ color: '#5F67EC' }}>
                            Send Message
                        </Button>
                    </Flex>
